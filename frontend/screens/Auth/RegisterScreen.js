...
const styles = StyleSheet.create({
  container: { flex: 1, justifyContent: 'center', padding: 30, backgroundColor: '#f4f0fc' },
  title: { fontSize: 28, fontWeight: '700', textAlign: 'center', marginBottom: 8, color: '#5E3C9B' },
  subtitle: { fontSize: 16, textAlign: 'center', marginBottom: 36, color: '#777' },
  button: { backgroundColor: 'black', paddingVertical: 14, paddingHorizontal: 20, borderRadius: 10, marginBottom: 25, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2, elevation: 2 },
  buttonText: { color: '#fff', fontSize: 16, fontWeight: '600', textAlign: 'center' },
  link: { color: '#5E3C9B', fontSize: 14, textAlign: 'center', textDecorationLine: 'underline' }
});